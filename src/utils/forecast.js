...
const forecast=(latitude,longitude,callback)=>{
 ...
 callback(undefined,
  ...
  //const feelike =response.body.current.feelslike
	response.body.current.weather_descriptions[0]+ ', it is currently '+ response.body.current.temperature +' out. It feels like '+ response.body.current.feelslike + ' degrees out.'+' The Humidity is'+ response.body.current.humidity + '%.'
	)
